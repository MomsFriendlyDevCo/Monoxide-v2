...
module.exports = function MonoxideCollection(o, name, schema) {
	...
	*/
	c.createCollection = ()=> {
		if (!c.schema) throw new Error('MonoxideCollection.schema needs to be populated before a table can be created');
	...
	*/
	...
	if (schema) c.schema = new o.classes.Schema(o, c, schema);
