...
module.exports = function MonoxideModel(o, name, schema) {
	...
	*/
	...
	/*
	* Add a method to a model, this method will be available on all documents that are non-lean
	* @param {string} name The name of the method to add
	* @param {function} func The function payload of the method
	* @returns {MonoxideModel} This chainable model
	*/
	...
	*/
	...
	/*
	* Add a virtual to a model this acts like a glued-on field for a non-lean document
	...
	* @returns {MonoxideModel} This chainable model
	*/
	m.virtual = (name, getter, setter) => {
		m.virtuals[name] = {getter, setter};
		return m;
	};
	// }}}
